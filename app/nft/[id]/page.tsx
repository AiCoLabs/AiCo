  ...
  return (
    <div className="container mx-auto">
      ...
      <div className='grid grid-cols-2 gap-14 text-lg text-white mt-14'>
        <div>
          <Image className="w-full h-[37.68rem]" src={collectionItem.logo} alt='card' />
        ...
        <div>
          ...
          <div className='mt-4 break-all'>CInspirationCInspirationCInspirationCInspirationCInspirationCInspirationCInspirationCInspirationCInspiration</div>
